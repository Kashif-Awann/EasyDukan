...
//import { saveProfileData, uploadImage } from '../utils/firebaseFunctions';
...
const EditProfileForm = () => {
  ...
  //         const uploadTask = uploadBytesResumable(storageRef, image); uploadTask.on("state_changed", (snapshot: UploadTaskSnapshot) => { const progress = (snapshot.bytesTransferred / snapshot.totalBytes) * 100; setUpload(Math.round(progress)); console.log(`Upload is ${progress} done`)}, error => {console.error(error.message)}, () => {console.log("Uploaded Completed")});
  ...
  //         // Save user data after image upload
  ...
  //         firstName: firstName,
  //         lastName: lastName,
  //         phoneNumber: phoneNumber, // Parse as number
  //         imageUrl: imageUrl,
  //       };
